...
const TeamDetails = () => {
    ...
    return (
        <div className="detailsPage">
            ...
            <p>{description2}</p>
            <div className="logo">
                <a target="_blank" href={`https://${team.strFacebook}`} rel="noreferrer"><i class="fab fa-facebook fa-3x icon"></i></a>
                <a target="_blank" href={`https://${team.strYoutube}`} rel="noreferrer"><i class="fab fa-youtube fa-3x icon-youtube"></i></a>
                <a target="_blank" href={`https://${team.strTwitter}`} rel="noreferrer"><i class="fab fa-twitter fa-3x icon"></i></a>
                <a target="_blank" href={`https://${team.strInstagram}`} rel="noreferrer"><i class="fab fa-instagram-square fa-3x icon-instagram"></i></a>
            </div>
        </div>
    );
};
